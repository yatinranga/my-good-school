...
public class ExcelTemplateController {
	...
	public ResponseEntity<?> exportExampleTemplate(@RequestParam String type, HttpServletResponse response)
			throws IOException {
	...
	public ResponseEntity<?> uploadStakeholdersFromExcel(@RequestParam("file") MultipartFile file,
			@RequestParam("type") String type, @RequestParam(required = false, value = "schoolId") String schoolCid) {
